...
export const PlusIcon: React.FC<SVGProps> = ({ className = 'fill-gray-600', height = 24, width = 24 }) => (
...
export const MenuIcon: React.FC<SVGProps> = ({ className = 'fill-gray-600', height = 24, width = 24 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" height={height} width={width} className={className}>
...
export const SetIcon: React.FC<SVGProps> = ({ className = 'fill-gray-600', height = 24, width = 24 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" height={height} width={width} className={className}>
...
export const FolderIcon: React.FC<SVGProps> = ({ className = 'fill-gray-600', height = 24, width = 24 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" height={height} width={width} className={className}>
...
export const MoreIcon: React.FC<SVGProps> = ({ className = 'fill-gray-600', height = 24, width = 24 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" height={height} width={width} className={className}>
...
export const MinusIcon: React.FC<SVGProps> = ({ className = 'fill-gray-600', height = 24, width = 24 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" height={height} width={width} className={className}>
    <path d="M220.001-450.001v-59.998h519.998v59.998H220.001Z" />
  </svg>
);
export const ChevronRightIcon: React.FC<SVGProps> = ({ className = 'fill-gray-600', height = 24, width = 24 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" height={height} width={width} className={className}>
