      ...
      <section className={style.auth}>
        <div className={style.auth__wrapper}>
          ...
          <div className={style.auth__actions}>
            {/* <a href="https://github.com/login/oauth/authorize?client_id=6ca78242c90aa9a23be3&redirect_uri=http://localhost:7001/oauth/redirect">
            ...
            {/* <button onClick={resetLoggedState}>
              <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                <path
                  fillRule="evenodd"
